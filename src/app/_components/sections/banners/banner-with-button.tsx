...
export default function BannerWithButton({theme}: AiComponentProps) {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden px-6 py-2.5 sm:px-3.5 sm:before:flex-1 bg-gradient-to-r from-primary-600/[.1] to-ai-secondary">
